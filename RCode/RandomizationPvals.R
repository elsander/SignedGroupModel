...
## Version: 1.0.0
##
## This function calculates the statistical significance of
## the similarity between two partitions.
## The null model is generated by randomizing the group
## identity of species in the two partitions 'reps' times
## and calculating the similarity between the randomized partitions
## (reps = 1,000,000 by default for a p-value with 3 significant digits)
